                            ...
                            <tr class="border-b">
                                ...
                                <td class="px-2 py-1">
                                    <button onclick="showAdminDetail(this)"
                                        ...
                                        data-status="{{ $init['status'] }}">Lihat Selengkapnya</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
...
@push('scripts')
    <script>
        ...
        function showAddAdminModal() {
            ...
            document.getElementById('idField').style.display = 'none'; // Sembunyikan ID field
            openModal();
        }
        ...
        function showAdminDetail(button) {
            ...
            document.getElementById('idField').style.display = 'block'; // Tampilkan ID field
            openModal();
        }
